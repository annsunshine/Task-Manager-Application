...
class CheckTasksWindow(Toplevel):
    def __init__(self, parent, tasks_list):
        ...
        self.grab_set() #preventing users from interacting with other windows until the dialog is closed
        self.transient(parent) #ensuring the window stays on the top
        self.display_tasks() 
    ...
    def display_tasks(self):
        ...
        #display tasks
        for i, task in enumerate(self.tasks): #loop through a list and have access to both the index and the element
